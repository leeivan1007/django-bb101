...
class Cat(models.Model):
    bigcatid = models.CharField(db_column='bigCatID', max_length=1, blank=True, null=True)  # Field name made lowercase.
...
class Pub(models.Model):
    id = models.CharField(db_column='ID', unique=True, max_length=8, blank=True, null=True)  # Field name made lowercase.
